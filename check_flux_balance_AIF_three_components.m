...
function logical_inds = ... 
    check_flux_balance_AIF_three_components(stats, params, tolerance)
...
Birth_Z = params.alpha + params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg;
...
logical_inds = inds_X & inds_Y & inds_Z & inds_PR & inds_Complex;
