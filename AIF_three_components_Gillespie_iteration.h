// file: AIF_three_components_Gillespie_iteration.h
#ifndef AIF_THREE_COMPONENTS_GILLESPIE_ITERATION_H
#define AIF_THREE_COMPONENTS_GILLESPIE_ITERATION_H
...
// purpose: perform single Gillespie iteration for three component AIF system, possibly with some interesting modifications. 
// inputs:
//		P_x_y_z : an unordered map containing the joint probability distribution for the components x, y, z 
//		P_complex_x_y : an unordered map containing the joint probability distribution for the components complex (xy), x, y 
//		P_complex_pr_y : an unordered map containing the joint probability distribution for the components complex (xy), pr, y 
//		P_complex_x_z : an unordered map containing the joint probability distribution for the components complex (xy), x, z 
//		P_pr_x_y : an unordered map containing the joint probability distribution for the components pr, x, y 
//		P_pr_x_z : an unordered map containing the joint probability distribution for the components pr, x, z 
