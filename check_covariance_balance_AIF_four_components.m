...
function logical_inds = ... 
    check_covariance_balance_AIF_four_components(stats, params, tolerance)


% compute numerical lifetimes
tau_w = 1./params.beta_w;
...
LHS_WW = (params.beta_w.*stats.W_var)./...
    ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.W_avg);
RHS_WW = (stats.cov_HFx_W + stats.cov_HFy_W + params.k.*stats.cov_W_Y)./...
    ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.W_avg)...
    + (1./stats.W_avg);
mean_WW = abs(mean([LHS_WW,RHS_WW],2));
err_WW = abs(LHS_WW - RHS_WW)./mean_WW;
inds_WW = err_WW <= tolerance;
...
LHS_ZZ = (params.beta_z.*stats.Z_var)./...
    ((params.phi.*stats.W_avg).*stats.Z_avg);
RHS_ZZ = (params.phi.*stats.cov_W_Z)./...
    ((params.phi.*stats.W_avg).*stats.Z_avg)...
    + (1./stats.Z_avg);
...
LHS_XW = (1./tau_w).*(params.beta_w.*stats.cov_W_X)./...
    ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.X_avg) + ...
    (1./tau_x).*(params.C.*stats.cov_XY_W + params.beta_x.*stats.cov_W_X)./...
    ((params.C.*stats.XY_avg + params.beta_x.*stats.X_avg).*stats.W_avg);
RHS_XW = (1./tau_w).*(stats.cov_HFx_X + stats.cov_HFy_X + params.k.*stats.cov_X_Y)./...
    ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.X_avg) + ...
    (1./tau_x).*(params.theta.*stats.cov_W_Z + params.lambda.*stats.cov_Complex_W)./...
    ((params.C.*stats.XY_avg + params.beta_x.*stats.X_avg).*stats.W_avg);
mean_XW = abs(mean([LHS_XW,RHS_XW],2));
err_XW= abs(LHS_XW - RHS_XW)./mean_XW;
inds_XW = err_XW <= tolerance;
...
LHS_YW = (1./tau_w).*(params.beta_w.*stats.cov_W_Y)./...
    ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.Y_avg) + ...
    (1./tau_y).*(params.C.*stats.cov_XY_W + params.beta_y.*stats.cov_W_Y)./...
    ((params.C.*stats.XY_avg + params.beta_y.*stats.Y_avg).*stats.W_avg);
RHS_YW = (1./tau_w).*(stats.cov_HFx_Y + stats.cov_HFy_Y + params.k.*stats.Y_var)./...
    ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.Y_avg) + ...
    (1./tau_y).*(params.lambda.*stats.cov_Complex_W)./...
    ((params.C.*stats.XY_avg + params.beta_y.*stats.Y_avg).*stats.W_avg);
mean_YW = abs(mean([LHS_YW,RHS_YW],2));
err_YW= abs(LHS_YW - RHS_YW)./mean_YW;
inds_YW = err_YW <= tolerance;
...
if params.passive_reporter(1) == 1.0
    LHS_WPR = (1./tau_pr).*(params.beta_w.*stats.cov_PR_W)./...
        ((params.alpha +params.phi.*stats.W_avg + stats.HFy_avg + stats.HFx_avg).*stats.W_avg) + ...
        (1./tau_w).*(params.beta_w.*stats.cov_PR_W)./...
        ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.PR_avg);
    RHS_WPR = (1./tau_pr).*(stats.cov_HFx_W + stats.cov_HFy_W + params.k.*stats.cov_W_Y)./...
        ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.W_avg) + ...
        (1./tau_w).*(stats.cov_HFx_PR + stats.cov_HFy_PR + params.k.*stats.cov_PR_Y)./...
        ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.PR_avg);
else
   LHS_WPR = ones(size(params.gamma));
   RHS_WPR = ones(size(params.gamma));
end
mean_WPR = abs(mean([LHS_YPR,RHS_YPR],2));
err_WPR= abs(LHS_WPR - RHS_WPR)./mean_WPR;
inds_WPR = err_WPR <= tolerance;
...
LHS_Zcom = (1./tau_com).*((params.lambda + params.gamma).*stats.cov_Complex_Z)./...
    ...
    ((params.phi.*stats.W_avg).*stats.Complex_avg);
RHS_Zcom = (1./tau_com).*(params.C.*stats.cov_XY_Z)./...
    (((params.lambda + params.gamma).*stats.Complex_avg).*stats.Z_avg) + ...
    (1./tau_z).*(params.phi.*stats.cov_Complex_W)./...
    ((params.phi.*stats.W_avg).*stats.Complex_avg);
else
...
if (params.lambda(1) > 0 || params.gamma(1) > 0)
LHS_Wcom = (1./tau_com).*((params.lambda + params.gamma).*stats.cov_Complex_W)./...
    (((params.lambda + params.gamma).*stats.Complex_avg).*stats.W_avg) + ...
    (1./tau_w).*(params.beta_w.*stats.cov_Complex_W)./...
    ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.Complex_avg);
RHS_Wcom = (1./tau_com).*(params.C.*stats.cov_XY_W)./...
    (((params.lambda + params.gamma).*stats.Complex_avg).*stats.W_avg) + ...
    (1./tau_w).*(stats.cov_HFx_Complex + stats.cov_HFy_Complex + params.k.*stats.cov_Complex_Y)./...
    ((params.alpha +params.k.*stats.Y_avg + stats.HFy_avg + stats.HFx_avg).*stats.Complex_avg);
else
   LHS_Wcom = ones(size(params.gamma));
   RHS_Wcom = ones(size(params.gamma)); 
end
mean_Wcom = abs(mean([LHS_Wcom,RHS_Wcom],2));
err_Wcom = abs(LHS_Wcom - RHS_Wcom)./mean_Wcom;
inds_Wcom = err_Wcom <= tolerance;
...
logical_inds = inds_WW & inds_XW & inds_YW & inds_WPR & inds_Wcom...
    & inds_XX & inds_YY & inds_ZZ & inds_PRPR & inds_ComCom ...
